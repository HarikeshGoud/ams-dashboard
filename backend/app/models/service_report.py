...
class ServiceReport(Base):
    ...
    membrane_condition   = Column(String(30),  default="OK")
    uv_lamp_condition    = Column(String(30),  default="OK")
    sensors_condition    = Column(String(30),  default="OK")
    prefilter_condition  = Column(String(30),  default="OK")
